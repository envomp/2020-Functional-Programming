...
-- We can construct elements of type LEQ m n only when m â‰¤ n,
...
-- We can think of a term of type LEQ m n as a proof that m â‰¤ n.
...
-- The constructor S_leq says that if m â‰¤ n then S m â‰¤ S n.
-- We can prove the converse as well:
leq_pred  :  LEQ (S m) (S n) -> LEQ m n
leq_pred (S_leq m_leq_n)  =  m_leq_n


-- The constructor Z_leq says that for any n we have that 0 â‰¤ n.
-- We can also show that for any n we have n â‰¤ S n:
